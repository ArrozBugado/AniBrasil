...
nome_contador = "AniBrasil"
link_contador = "https://whos.amung.us/pingjs/"    


##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = "[B][COLOR white]||||||| ADDON AniBrasil|||||||[/COLOR][/B]"
###  DESCRIÇÃO DO ADDON ###############################################################
title_descricao = "Filmes, séries e animes"
...
url_origem = 'https://pastebin.com/raw/uaQDedtA'
try:
   ...
   if status_mensagem1 == 'true':
    ...
    if link == 0:
     if xbmc . getCondVisibility ( 'system.platform.android' ) :
         xbmc . executebuiltin ( 'StartAndroidActivity(,android.intent.action.VIEW,,%s)' % ( 'https://youtube.com/channel/UCGvTCt5wDVLTZKR4rzq2Bbw' ) )
     else:
        ost = webbrowser . open ( 'https://youtube.com/channel/UCGvTCt5wDVLTZKR4rzq2Bbw' )
